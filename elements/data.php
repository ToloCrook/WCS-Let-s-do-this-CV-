...
$dataFrench = [
    ...
    ["jon.snow@knowsnothing.com", "01.05.02.05.02", "4 rue du pied du Mur", "99 999 Châteaunoir", "WESTEROS", "<h3>Disponible</h3>"],
    ["Choisis une langue"],
...
$dataEnglish = [
    ...
    ["jon.snow@knowsnothing.com", "01.05.02.05.02", "4 road foot of the wall", "99 999 Castleblack", "WESTEROS", "<h3>Available</h3>"],
    ["Select a language"],
...
$dataValyrian = [
    ...
    ["jon.snow@knowsnothing.com", "01.05.02.05.02", "4 geralbar kaist hen dōros", "99 999 Castleblack", "WESTEROS", "<h3>Jorrāelagon</h3>"],
