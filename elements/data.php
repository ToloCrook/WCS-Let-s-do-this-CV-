...
$dataFrench = [
    ...
    ['<a href="mailto:jon.snow@knowsnothing.com">jon.snow@knowsnothing.com</a>', "01.05.02.05.02", "4 rue du pied du Mur", "99 999 Châteaunoir", "WESTEROS", "<strong>Disponible</strong>"],
    ["Choisis une langue"],
...
$dataEnglish = [
    ...
    ['<a href="mailto:jon.snow@knowsnothing.com">jon.snow@knowsnothing.com</a>', "01.05.02.05.02", "4 road foot of the wall", "99 999 Castleblack", "WESTEROS", "<strong>Available</strong>"],
    ["Select a language"],
...
$dataValyrian = [
    ...
    ["- Bisa proravis iksis jookul naejot", "- Orgoz nyke hen sīr jaelan", "- Naejot tatagon ziry", "- Hae adere hae possible sīr īlon ȳdra", "- Daor mirre va bisa dombo", "- Se se mōrī mēre naejot tatagon"],
    ...
    ['<a href="mailto:jon.snow@knowsnothing.com">jon.snow@knowsnothing.com</a>', "01.05.02.05.02", "4 geralbar kaist hen dōros", "99 999 Castleblack", "WESTEROS", "<strong>Jorrāelagon</strong>"],
